# src/routes/api_routes.py - VERSÃO CORRIGIDA COMPLETA

# ✅ IMPORTS CORRETOS
from datetime import datetime  # ✅ CORRIGIDO - sem .datetime
from flask import Blueprint, request, jsonify, current_app
from src.s3_manager import list_s3_contents_by_prefix, list_all_s3_buckets, check_s3_object_exists, upload_to_s3
from src.orchestrator import run_b3_scraping_and_upload
from src.athena_service import execute_athena_query
